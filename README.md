...
|--------------------- | ---------- | ------------------------------- | ------- |       :-:       |
| **AI-ML-DS** |  | Искусственный интеллект, машинное обучение, Data Science | Gitter: https://gitter.im/dev-ua/ai-ml-ds |  |
...
| **AngularJS UA** |  | AngularJS, Javascript | Gitter: http://angular.im |  |
...
| **Clojure UA** |  | Clojure, Clojurescript,  FP | Gitter: https://gitter.im/dev-ua/clojure |  |
| **Dart group** |  | Dart | Gitter: https://gitter.im/dev-ua/dart<br>Skype: http://bit.ly/dart-chat |  |
...
| **Ember Chat** |  | EmberJS | Gitter: https://gitter.im/dev-ua/ember |  |
...
| **Frontend UA** |  | HTML5, CSS3, Javascript, ... | Gitter: http://frontendua.im |  |
...
| **Go Lang** |  | Go | Gitter: https://gitter.im/dev-ua/go<br>Skype: http://is.gd/0hu7AR |  |
...
| **Haskell UA** |  | Haskell Chat | Gitter: https://gitter.im/dev-ua/haskell |  |
...
| **Javascript.ru** |  | javascript, nodejs, angularjs, reactjs, ... | Slack: http://slack.javascript.ru/ |  |
...
| **NodeJS UA** |  | NodeJS + DevOps and NoSQL | Gitter: https://gitter.im/dev-ua/node |  |
...
| **PHP UA** |  | PHP | Gitter: https://gitter.im/dev-ua/php<br>Skype: http://bit.ly/php-ua | Chat migrated to Gitter |
...
| **ReactJS** |  | ReactJS, Flux, Redux | Gitter: https://gitter.im/dev-ua/reactjs<br>Skype: http://bit.ly/reactjs-chat |  |
| **Ruby/RoR** |  | Ruby, Rails | Gitter: https://gitter.im/dev-ua/ruby-ua<br>Skype: http://bit.ly/ruby-ua |  |
| **Ruby&whatever** |  | Ruby | Skype: http://tinyurl.com/rubyconf | Just be a good person. |
| **RustUA** |  | Rust | Gitter: https://gitter.im/dev-ua/rust |  |
...
| **Scala UA** |  | Scala, JVM | Gitter: https://gitter.im/dev-ua/scala<br>Skype: http://bit.ly/scala-ua | Skype is a read-only archive |
| **SwiftChat** |  | Swift, iOS, OSX | Skype: http://bit.ly/swift_skype_chat |  |
| **ScalaChat** |  | Scala, JVM, Software Design | Gitter: https://gitter.im/dev-ua/scala<br>Slack: https://scala-ru.herokuapp.com<br>Skype: http://bit.ly/scalachat |  |
...
| **Unity** |  | Unity Engine | Gitter: https://gitter.im/dev-ua/unity |  |
